...
var stimuli_to_show = [within_stim,within_stim,within_stim,within_stim,within_stim,within_stim];
...
var other_unpermuted_for_trial = [0,0,0,0,0,0];
var target_prop_unpermuted_for_trial;/// = [2,1,2];
var distractor_prop_unpermuted_for_trial;/// = [1,2,1];
var trials_completed = 0;

var sequence_condition = 1;//random(0,1);///1 for 0w,1w,1b; 0 for 1w,0w,1b
if(0 === sequence_condition)
{
    target_unpermuted_for_trial = [1,2,1,2,1,2];
    distractor_unpermuted_for_trial = [2,1,2,1,2,1];
    //choice_names_unpermuted_for_trial = [["foil","target","logical"],["foil","logical","target"],["foil","target","logical"]];
    target_prop_unpermuted_for_trial = [2,1,2,1,2,1];
    distractor_prop_unpermuted_for_trial = [1,2,1,2,1,2];
}
else
{
    target_unpermuted_for_trial = [2,1,2,1,2,1];
    distractor_unpermuted_for_trial = [1,2,1,2,1,2];
    //choice_names_unpermuted_for_trial = [["foil","logical","target"],["foil","target","logical"],["foil","target","logical"]];
    target_prop_unpermuted_for_trial = [1,2,1,2,1,2];
    distractor_prop_unpermuted_for_trial = [2,1,2,1,2,1];
}
...
var permute_before_trial = [1,0,0,0,0,0];///whether to permute the matrix before trial n
...
var num_trials = 6;///formerly hardcoded as 6 in control flow code
