	...
	next_familiarization: function() {
		...
		if (window.self == window.top | turk.workerId.length > 0) {
			...
			else
			{
				...
				$("#testNextButton").hide();
				$("#continueText").show();
				$("#continueText").html('<p class="block-text"><center>Click "Continue" for another question about the ' + plural + ' (' + (trials_completed+1) + '/' + num_trials + '):</center></p>');
				$("#continueButton").show();
			}
		}
	},
   ...
   // FINISHED BUTTON CHECKS EVERYTHING AND THEN ENDS
    ...
    // END FUNCTION 
    	...
    	if(0 === sequence_condition)//1w,0w,1b
    	{
    		...
    		switch(experiment.choice_n[3])
    		{
    			case "target": experiment.choice_4 = "logical"; break;
    			case "logical": experiment.choice_4 = "target"; break;
    			case "foil": experiment.choice_4 = "foil"; break;
    			default: experiment.choice_4 = "error"; break;
    		}
    		experiment.choice_5 = experiment.choice_n[4];
    		switch(experiment.choice_n[5])
    		{
    			case "target": experiment.choice_6 = "logical"; break;
    			case "logical": experiment.choice_6 = "target"; break;
    			case "foil": experiment.choice_6 = "foil"; break;
    			default: experiment.choice_6 = "error"; break;
    		}
    		experiment.sequence_condition = "(1w0w)x3";
    	}
    	else//0w,1w,1b
    	{
    		...
    		experiment.choice_4 = experiment.choice_n[3];
    		switch(experiment.choice_n[4])
    		{
    			case "target": experiment.choice_5 = "logical"; break;
    			case "logical": experiment.choice_5 = "target"; break;
    			case "foil": experiment.choice_5 = "foil"; break;
    	...
    	experiment.choice_correct_4 = ("target" == experiment.choice_4);
    	experiment.choice_correct_5 = ("target" == experiment.choice_5);
    	experiment.choice_correct_6 = ("target" == experiment.choice_6);

    	experiment.item_1 = experiment.item_n[0];
    	experiment.item_2 = experiment.item_n[1];
    	experiment.item_3 = experiment.item_n[2];
    	experiment.item_4 = experiment.item_n[3];
    	experiment.item_5 = experiment.item_n[4];
    	experiment.item_6 = experiment.item_n[5];
    	...
    	experiment.target_prop_4 = experiment.target_prop_n[3];
    	experiment.target_prop_5 = experiment.target_prop_n[4];
    	experiment.target_prop_6 = experiment.target_prop_n[5];
    	...
    	experiment.target_position_4 = experiment.target_position_n[3];
    	experiment.target_position_5 = experiment.target_position_n[4];
    	experiment.target_position_6 = experiment.target_position_n[5];
    	...
    	experiment.distractor_prop_4 = experiment.distractor_prop_n[3];
    	experiment.distractor_prop_5 = experiment.distractor_prop_n[4];
    	experiment.distractor_prop_6 = experiment.distractor_prop_n[5];
    	...
    	experiment.distractor_position_4 = experiment.distractor_position_n[3];
    	experiment.distractor_position_5 = experiment.distractor_position_n[4];
    	experiment.distractor_position_6 = experiment.distractor_position_n[5];
