...
var experiment = {
   ...
   // FINISHED BUTTON CHECKS EVERYTHING AND THEN ENDS
    ...
    // END FUNCTION 
    	...
    	if(0 === sequence_condition)//0w,2w,1w//0w,1w,2w
    	{
    		...
    		switch(experiment.choice_n[2])
    		{
    			...
    			case "logical": experiment.choice_3 = "foil"; break;
    			case "foil": experiment.choice_3 = "target"; break;
    			default: experiment.choice_3 = "error"; break;
    		}
    		experiment.sequence_condition = "0w2w1w";
    	}
    	else//1w,2w,0w//2w,1w,0w
    	{
    		switch(experiment.choice_n[0])
    		{
    			case "target": experiment.choice_1 = "logical"; break;
    			case "logical": experiment.choice_1 = "foil"; break;
    			case "foil": experiment.choice_1 = "target"; break;
    			default: experiment.choice_1 = "error"; break;
    		}
    		experiment.choice_2 = experiment.choice_n[1];
    		switch(experiment.choice_n[2])
