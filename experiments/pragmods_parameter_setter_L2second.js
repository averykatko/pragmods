...
//ITER
var sequence_condition = random(0,1);//0 for 0w,2w,1w; 1 for 1w,2w,0w
if(0 === sequence_condition)
{
    target_unpermuted_for_trial = [2,1,0];
    distractor_unpermuted_for_trial = [0,2,1];
    other_unpermuted_for_trial = [1,0,2];
    //choice_names_unpermuted_for_trial = [["foil","target","logical"],["foil","logical","target"],["foil","target","logical"]];
    target_prop_unpermuted_for_trial = [2,1,0];
    distractor_prop_unpermuted_for_trial = [0,1,2];
}
else
{
    target_unpermuted_for_trial = [0,1,2];
    distractor_unpermuted_for_trial = [1,2,0];
    other_unpermuted_for_trial = [2,0,1];
    //choice_names_unpermuted_for_trial = [["foil","logical","target"],["foil","target","logical"],["foil","target","logical"]];
    target_prop_unpermuted_for_trial = [0,1,2];
    distractor_prop_unpermuted_for_trial = [1,2,0];
}
